...
out_dir <- "melaenornis_demography"

# column headers
vcf_colnames <- c("POS", "REF", "ALT", "10", "11", "6", "7", "8", "9")
options(scipen=999)

# set up names of individuals
ind_names <- c("M_chocolatinus_EB063", "M_chocolatinus_EB067", "M_chocolatinus_EB002", "M_chocolatinus_EB003", "M_chocolatinus_EB053", "M_chocolatinus_EB059")

...
out_dir <- "crithagra_demography"

# column headers
vcf_colnames <- c("POS", "REF", "ALT", "15", "16", "17", "18", "19")
options(scipen=999)

# set up names of individuals
ind_names <- c("C_tristriata_EB007", "C_tristriata_EB015", "C_tristriata_EB043", "C_tristriata_EB058", "C_tristriata_EB064")

...
out_dir <- "turdus_demography"

# column headers
vcf_colnames <- c("POS", "REF", "ALT", "20", "21", "22", "23", "24", "25")
options(scipen=999)

# set up names of individuals
ind_names <- c("T_abyssinicus_EB001", "T_abyssinicus_EB006", "T_abyssinicus_EB010", "T_abyssinicus_EB042", "T_abyssinicus_EB045", "T_abyssinicus_EB046")

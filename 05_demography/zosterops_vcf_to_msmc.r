...
# column headers
vcf_colnames <- c("POS", "REF", "ALT", "26", "27", "28", "29", "30")
options(scipen=999)

# set up names of individuals
ind_names <- c("Z_poliogastrus_EB013", "Z_poliogastrus_EB049", "Z_poliogastrus_EB050", "Z_poliogastrus_EB051", "Z_poliogastrus_EB065")
